...
func (o *Genre) Novels(mods ...qm.QueryMod) novelQuery {
	...
	queryMods = append(queryMods,
		qm.InnerJoin("\"ste\".\"genre_of_novel\" on \"ste\".\"novel\".\"id\" = \"ste\".\"genre_of_novel\".\"novel_id\""),
		qm.Where("\"ste\".\"genre_of_novel\".\"genre_id\"=?", o.ID),
	)
...
func (genreL) LoadNovels(ctx context.Context, e boil.ContextExecutor, singular bool, maybeGenre interface{}, mods queries.Applicator) error {
	var slice []*Genre
	var object *Genre
	...
	query := NewQuery(
		qm.Select("\"ste\".\"novel\".*, \"a\".\"genre_id\""),
		qm.From("\"ste\".\"novel\""),
		qm.InnerJoin("\"ste\".\"genre_of_novel\" as \"a\" on \"ste\".\"novel\".\"id\" = \"a\".\"novel_id\""),
...
func (o *Genre) AddNovels(ctx context.Context, exec boil.ContextExecutor, insert bool, related ...*Novel) error {
	var err error
	...
	for _, rel := range related {
		query := "insert into \"ste\".\"genre_of_novel\" (\"genre_id\", \"novel_id\") values ($1, $2)"
...
// Sets o.R.Genres's Novels accordingly.
// Replaces o.R.Novels with related.
// Sets related.R.Genres's Novels accordingly.
func (o *Genre) SetNovels(ctx context.Context, exec boil.ContextExecutor, insert bool, related ...*Novel) error {
	query := "delete from \"ste\".\"genre_of_novel\" where \"genre_id\" = $1"
	...
	removeNovelsFromGenresSlice(o, related)
	if o.R != nil {
		o.R.Novels = nil
	}
...
func (o *Genre) RemoveNovels(ctx context.Context, exec boil.ContextExecutor, related ...*Novel) error {
	var err error
	query := fmt.Sprintf(
		"delete from \"ste\".\"genre_of_novel\" where \"genre_id\" = $1 and \"novel_id\" in (%s)",
...
func removeNovelsFromGenresSlice(o *Genre, related []*Novel) {
	for _, rel := range related {
		if rel.R == nil {
			continue
		}
...
func Genres(mods ...qm.QueryMod) genreQuery {
	mods = append(mods, qm.From("\"ste\".\"genre\""))
...
func FindGenre(ctx context.Context, exec boil.ContextExecutor, iD int, selectCols ...string) (*Genre, error) {
	...
	query := fmt.Sprintf(
		"select %s from \"ste\".\"genre\" where \"id\"=$1", sel,
	)
...
func (o *Genre) Insert(ctx context.Context, exec boil.ContextExecutor, columns boil.Columns) error {
	...
	if !cached {
		...
		if len(wl) != 0 {
			cache.query = fmt.Sprintf("INSERT INTO \"ste\".\"genre\" (\"%s\") %%sVALUES (%s)%%s", strings.Join(wl, "\",\""), strmangle.Placeholders(dialect.UseIndexPlaceholders, len(wl), 1, 1))
		} else {
			cache.query = "INSERT INTO \"ste\".\"genre\" %sDEFAULT VALUES%s"
		}
...
func (o *Genre) Update(ctx context.Context, exec boil.ContextExecutor, columns boil.Columns) (int64, error) {
	...
	if !cached {
		...
		cache.query = fmt.Sprintf("UPDATE \"ste\".\"genre\" SET %s WHERE %s",
...
func (o GenreSlice) UpdateAll(ctx context.Context, exec boil.ContextExecutor, cols M) (int64, error) {
	...
	sql := fmt.Sprintf("UPDATE \"ste\".\"genre\" SET %s WHERE %s",
...
func (o *Genre) Upsert(ctx context.Context, exec boil.ContextExecutor, updateOnConflict bool, conflictColumns []string, updateColumns, insertColumns boil.Columns) error {
	...
	if !cached {
		...
		cache.query = buildUpsertQueryPostgres(dialect, "\"ste\".\"genre\"", updateOnConflict, ret, update, conflict, insert)
...
func (o *Genre) Delete(ctx context.Context, exec boil.ContextExecutor) (int64, error) {
	...
	sql := "DELETE FROM \"ste\".\"genre\" WHERE \"id\"=$1"
...
func (o GenreSlice) DeleteAll(ctx context.Context, exec boil.ContextExecutor) (int64, error) {
	...
	sql := "DELETE FROM \"ste\".\"genre\" WHERE " +
...
func (o *GenreSlice) ReloadAll(ctx context.Context, exec boil.ContextExecutor) error {
	...
	sql := "SELECT \"ste\".\"genre\".* FROM \"ste\".\"genre\" WHERE " +
		strmangle.WhereClauseRepeated(string(dialect.LQ), string(dialect.RQ), 1, genrePrimaryKeyColumns, len(*o))
...
func GenreExists(ctx context.Context, exec boil.ContextExecutor, iD int) (bool, error) {
	var exists bool
	sql := "select exists(select 1 from \"ste\".\"genre\" where \"id\"=$1 limit 1)"
